        ...
        <aside className="border-b border-slate-200 bg-[#081220] text-white xl:border-b-0 xl:border-r xl:border-slate-800">
          <div className="flex h-full flex-col justify-between px-6 py-8 lg:px-7">
            ...
            <div className="mt-8 space-y-4">
              ...
              <Link href="/admin" className="block text-center rounded-xl bg-amber-400/10 border border-amber-400/35 hover:bg-amber-400/15 py-3 px-4 transition">
                <p className="text-[10px] uppercase font-bold tracking-wider text-amber-300">🔍 Fraud Analyst Console</p>
                <p className="text-[11px] text-white/80 mt-1 font-medium">Open Saathi Risk Dashboard</p>
              </Link>
